...
public class BioTechWP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bio_tech_wp);
        spinnerYear = findViewById(R.id.bt_choose_year);
        spinnerCourse=findViewById(R.id.bt_courses);
        ArrayAdapter<CharSequence> courseAdapter = ArrayAdapter.createFromResource(this, R.array.Bio_Courses, android.R.layout.simple_spinner_item);
        ...
        csTitle = findViewById(R.id.bt_title);
        csProgressBar = findViewById(R.id.bt_progress_bar);
        csProgressBar.setVisibility(View.INVISIBLE);
        csBody = findViewById(R.id.bt_post_body);
        ...
        csPostButton = findViewById(R.id.bt_post_button);
        firebaseAuth = FirebaseAuth.getInstance();
        fStore = FirebaseFirestore.getInstance();
        databaseReference = FirebaseDatabase.getInstance().getReference("BIOTECH_POSTS");
        databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
        storageReference = FirebaseStorage.getInstance().getReference("BIOTECH_IMAGES");
        ...
        csPostButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(uploadTask!=null&&uploadTask.isInProgress()){
                    Toast.makeText(BioTechWP.this, "Upload In Progress", Toast.LENGTH_SHORT).show();
                }
                else{
                    if(csTitle.getText().toString().isEmpty()||csBody.getText().toString().isEmpty()){
                        Toast.makeText(BioTechWP.this,"Title and body fields can't be left empty",Toast.LENGTH_LONG).show();
                    }
                    else {
                        postUpload();
                    }
                            ...
                            if (uri2 != null) {
                                                ...
                                                if (uri3 != null) {
                                                                    ...
                                                                    if (uri4 != null) {
                                                                                        ...
                                                                                        if(uri5!=null){
                                                                                            ...
                                                                                            uploadTask=fileRef5.putFile(uri5).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                                                                                            ...
                                                                                                            documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                                                                ...
                                                                                                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                                                                    ...
                                                                                                                    DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                                                                            url2.toString(),url3.toString(),url4.toString(),url5.toString(),userName,dateTime,"BT",pID);
                                                                                                                    ...
                                                                                                                    Toast.makeText(BioTechWP.this, "Posted", Toast.LENGTH_SHORT).show();
                                                                                                                    finish();
                                                                                                                }
                                                                                                            });
                                                                                                ...
                                                                                                public void onFailure(@NonNull Exception e) {
                                                                                                    Toast.makeText(BioTechWP.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                                                                                }
                                                                                            ...
                                                                                            documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                                                ...
                                                                                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                                                    ...
                                                                                                    String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                                                                                    DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                                                            url2.toString(),url3.toString(),url4.toString(),url5,userName,dateTime,"BT",pID);
                                                                                                    databaseReference.child(pID).setValue(departmentPost);
                                                                                                    String userId=firebaseAuth.getCurrentUser().getUid();
                                                                                                    DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                                                                                    databaseReference2.child(userId).child(pID).setValue(departmentPost);
                                                                        ...
                                                                        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                            ...
                                                                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                                ...
                                                                                String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                                                                DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                                        url2.toString(),url3.toString(),url4,url5,userName,dateTime,"BT",pID);
                                                                                databaseReference.child(pID).setValue(departmentPost);
                                                                                String userId=firebaseAuth.getCurrentUser().getUid();
                                                                                DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                                                                databaseReference2.child(userId).child(pID).setValue(departmentPost);
                                                    ...
                                                    documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                        ...
                                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                            ...
                                                            String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                                            DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                    url2.toString(),url3,url4,url5,userName,dateTime,"BT",pID);
                                                            databaseReference.child(pID).setValue(departmentPost);
                                                            String userId=firebaseAuth.getCurrentUser().getUid();
                                                            DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                                            databaseReference2.child(userId).child(pID).setValue(departmentPost);
                                ...
                                documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                    ...
                                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                                        ...
                                        String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                        DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                url2,url3,url4,url5,userName,dateTime,"BT",pID);
                                        databaseReference.child(pID).setValue(departmentPost);
                                        String userId=firebaseAuth.getCurrentUser().getUid();
                                        DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                        databaseReference2.child(userId).child(pID).setValue(departmentPost);
