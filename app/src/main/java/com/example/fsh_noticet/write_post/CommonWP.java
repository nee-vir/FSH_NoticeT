...
public class CommonWP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_common_wp);
        cText=findViewById(R.id.common_text);
        String text = cText.getText().toString();
        csTitle = findViewById(R.id.cp_title);
        csProgressBar = findViewById(R.id.cp_progress_bar);
        csProgressBar.setVisibility(View.INVISIBLE);
        csBody = findViewById(R.id.cp_post_body);
        ...
        csPostButton = findViewById(R.id.cp_post_button);
        firebaseAuth = FirebaseAuth.getInstance();
        fStore = FirebaseFirestore.getInstance();
        databaseReference = FirebaseDatabase.getInstance().getReference("COMMON_POSTS");
        storageReference = FirebaseStorage.getInstance().getReference("COMMON_IMAGES");
        ...
        csPostButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(uploadTask!=null&&uploadTask.isInProgress()){
                    Toast.makeText(CommonWP.this, "Upload In Progress", Toast.LENGTH_SHORT).show();
                }
                else{
                    if(csTitle.getText().toString().isEmpty()||csBody.getText().toString().isEmpty()){
                        Toast.makeText(CommonWP.this,"Title and body fields can't be left empty",Toast.LENGTH_LONG).show();
                    }
                    else {
                        postUpload();
                    }
                            ...
                            if (uri2 != null) {
                                                ...
                                                if (uri3 != null) {
                                                                    ...
                                                                    if (uri4 != null) {
                                                                                        ...
                                                                                        if(uri5!=null){
                                                                                            ...
                                                                                            uploadTask=fileRef5.putFile(uri5).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                                                                                ...
                                                                                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                                                                    fileRef5.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                                                                        ...
                                                                                                        public void onSuccess(Uri uri) {
                                                                                                            final Uri url5=uri;
                                                                                                            final String course="FOR";
                                                                                                            final String year="EVERYONE";
                                                                                                            ...
                                                                                                            documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                                                                ...
                                                                                                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                                                                    ...
                                                                                                                    DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                                                                            url2.toString(),url3.toString(),url4.toString(),url5.toString(),userName,dateTime,"CP",pID);
                                                                                                                    ...
                                                                                                                    Toast.makeText(CommonWP.this, "Posted", Toast.LENGTH_SHORT).show();
                                                                                                                    finish();
                                                                                                                }
                                                                                                            });
                                                                                                ...
                                                                                                public void onFailure(@NonNull Exception e) {
                                                                                                    Toast.makeText(CommonWP.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                                                                                }
                                                                                            ...
                                                                                            documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                                                ...
                                                                                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                                                    ...
                                                                                                    String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                                                                                    DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                                                            url2.toString(),url3.toString(),url4.toString(),url5,userName,dateTime,"CP",pID);
                                                                                                    databaseReference.child(pID).setValue(departmentPost);
                                                                                                    String userId=firebaseAuth.getCurrentUser().getUid();
                                                                                                    DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                                                                                    databaseReference2.child(userId).child(pID).setValue(departmentPost);
                                                                        ...
                                                                        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                            ...
                                                                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                                ...
                                                                                String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                                                                DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                                        url2.toString(),url3.toString(),url4,url5,userName,dateTime,"CP",pID);
                                                                                databaseReference.child(pID).setValue(departmentPost);
                                                                                String userId=firebaseAuth.getCurrentUser().getUid();
                                                                                DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                                                                databaseReference2.child(userId).child(pID).setValue(departmentPost);
                                                    ...
                                                    documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                        ...
                                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                            ...
                                                            String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                                            DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                    url2.toString(),url3,url4,url5,userName,dateTime,"CP",pID);
                                                            databaseReference.child(pID).setValue(departmentPost);
                                                            String userId=firebaseAuth.getCurrentUser().getUid();
                                                            DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                                            databaseReference2.child(userId).child(pID).setValue(departmentPost);
                                ...
                                documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                    ...
                                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                                        ...
                                        String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                        DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                url2,url3,url4,url5,userName,dateTime,"CP",pID);
                                        databaseReference.child(pID).setValue(departmentPost);
                                        String userId=firebaseAuth.getCurrentUser().getUid();
                                        DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                        databaseReference2.child(userId).child(pID).setValue(departmentPost);
