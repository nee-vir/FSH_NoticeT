...
public class ComputerScienceWP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_science_wp);
        spinnerYear = findViewById(R.id.cs_choose_year);
        spinnerCourse=findViewById(R.id.cs_courses);
        ArrayAdapter<CharSequence> courseAdapter = ArrayAdapter.createFromResource(this, R.array.CS_Courses, android.R.layout.simple_spinner_item);
        ...
        csProgressBar = findViewById(R.id.cs_progress_bar);
        csProgressBar.setVisibility(View.INVISIBLE);
        csBody = findViewById(R.id.cs_post_body);
        ...
        csPostButton = findViewById(R.id.cs_post_button);
        firebaseAuth = FirebaseAuth.getInstance();
        fStore = FirebaseFirestore.getInstance();
        databaseReference = FirebaseDatabase.getInstance().getReference("COMPUTER_SCIENCE_POSTS");
        storageReference = FirebaseStorage.getInstance().getReference("COMPUTER_SCIENCE_IMAGES");
        ...
        csPostButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(uploadTask!=null&&uploadTask.isInProgress()){
                    Toast.makeText(ComputerScienceWP.this, "Upload In Progress", Toast.LENGTH_SHORT).show();
                }
                else{
                    if(csTitle.getText().toString().isEmpty()||csBody.getText().toString().isEmpty()){
                        Toast.makeText(ComputerScienceWP.this,"Title and body fields can't be left empty",Toast.LENGTH_LONG).show();
                    }
                    else {
                        postUpload();
                    }
                            ...
                            if (uri2 != null) {
                                                ...
                                                if (uri3 != null) {
                                                                    ...
                                                                    if (uri4 != null) {
                                                                                        ...
                                                                                        if(uri5!=null){
                                                                                            ...
                                                                                            uploadTask=fileRef5.putFile(uri5).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                                                                                            ...
                                                                                                            documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                                                                ...
                                                                                                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                                                                    ...
                                                                                                                    DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                                                                            url2.toString(),url3.toString(),url4.toString(),url5.toString(),userName,dateTime,"CS",pID);
                                                                                                                    ...
                                                                                                                    Toast.makeText(ComputerScienceWP.this, "Posted", Toast.LENGTH_SHORT).show();
                                                                                                                    finish();
                                                                                                                }
                                                                                                            });
                                                                                                ...
                                                                                                public void onFailure(@NonNull Exception e) {
                                                                                                    Toast.makeText(ComputerScienceWP.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                                                                                }
                                                                                            ...
                                                                                            documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                                                ...
                                                                                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                                                    ...
                                                                                                    String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                                                                                    DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                                                            url2.toString(),url3.toString(),url4.toString(),url5,userName,dateTime,"CS",pID);
                                                                                                    databaseReference.child(pID).setValue(departmentPost);
                                                                                                    String userId=firebaseAuth.getCurrentUser().getUid();
                                                                                                    DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                                                                                    databaseReference2.child(userId).child(pID).setValue(departmentPost);
                                                                        ...
                                                                        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                            ...
                                                                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                                ...
                                                                                String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                                                                DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                                        url2.toString(),url3.toString(),url4,url5,userName,dateTime,"CS",pID);
                                                                                databaseReference.child(pID).setValue(departmentPost);
                                                                                String userId=firebaseAuth.getCurrentUser().getUid();
                                                                                DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                                                                databaseReference2.child(userId).child(pID).setValue(departmentPost);
                                                    ...
                                                    documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                        ...
                                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                            ...
                                                            String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                                            DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                    url2.toString(),url3,url4,url5,userName,dateTime,"CS",pID);
                                                            databaseReference.child(pID).setValue(departmentPost);
                                                            String userId=firebaseAuth.getCurrentUser().getUid();
                                                            DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                                            databaseReference2.child(userId).child(pID).setValue(departmentPost);
                                ...
                                documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                    ...
                                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                                        ...
                                        String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                        DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                url2,url3,url4,url5,userName,dateTime,"CS",pID);
                                        databaseReference.child(pID).setValue(departmentPost);
                                        String userId=firebaseAuth.getCurrentUser().getUid();
                                        DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                        databaseReference2.child(userId).child(pID).setValue(departmentPost);
