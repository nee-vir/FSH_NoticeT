...
public class ComputerApplicationsWP extends AppCompatActivity {
    private Spinner spinnerCourse,spinnerYear;
    private Button cAPostButton;
    private EditText cATitle, cABody;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_applications_wp);
        spinnerYear = findViewById(R.id.choose_year);
        spinnerCourse=findViewById(R.id.ca_courses);
        ArrayAdapter<CharSequence> courseAdapter = ArrayAdapter.createFromResource(this, R.array.CA_Courses, android.R.layout.simple_spinner_item);
        ...
        cAProgressBar = findViewById(R.id.new_progress_bar);
        cAProgressBar.setVisibility(View.INVISIBLE);
        cABody = findViewById(R.id.ca_post_body);
        ...
        cAPostButton = findViewById(R.id.ca_post_button);
        firebaseAuth = FirebaseAuth.getInstance();
        fStore = FirebaseFirestore.getInstance();
        databaseReference = FirebaseDatabase.getInstance().getReference("COMPUTER_APPLICATIONS_POSTS");
        storageReference = FirebaseStorage.getInstance().getReference("COMPUTER APPLICATIONS IMAGES");
        ...
        cAPostButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(uploadTask!=null&&uploadTask.isInProgress()){
                    Toast.makeText(ComputerApplicationsWP.this, "Upload In Progress", Toast.LENGTH_SHORT).show();
                }
                else{
                    if(cATitle.getText().toString().isEmpty()||cABody.getText().toString().isEmpty()){
                        Toast.makeText(ComputerApplicationsWP.this,"Title and body fields can't be left empty",Toast.LENGTH_LONG).show();
                    }
                    else {
                        postUpload();
                    }
                            ...
                            if (uri2 != null) {
                                                ...
                                                if (uri3 != null) {
                                                                    ...
                                                                    if (uri4 != null) {
                                                                                        ...
                                                                                        if(uri5!=null){
                                                                                            ...
                                                                                            uploadTask=fileRef5.putFile(uri5).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                                                                                ...
                                                                                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                                                                    fileRef5.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                                                                        ...
                                                                                                        public void onSuccess(Uri uri) {
                                                                                                            ...
                                                                                                            final String title=cATitle.getText().toString();
                                                                                                            final String body=cABody.getText().toString();
                                                                                                            ...
                                                                                                            documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                                                                ...
                                                                                                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                                                                    ...
                                                                                                                    DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                                                                            url2.toString(),url3.toString(),url4.toString(),url5.toString(),userName,dateTime,"CA",pID);
                                                                                                                    ...
                                                                                                                    Toast.makeText(ComputerApplicationsWP.this, "Posted", Toast.LENGTH_SHORT).show();
                                                                                                                    finish();
                                                                                                                }
                                                                                                            });
                                                                                                ...
                                                                                                public void onFailure(@NonNull Exception e) {
                                                                                                    Toast.makeText(ComputerApplicationsWP.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                                                                                }
                                                                                            }).addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                                                                                                @Override
                                                                                                public void onProgress(@NonNull UploadTask.TaskSnapshot taskSnapshot) {
                                                                                                    double progress=(100.0*taskSnapshot.getBytesTransferred()/taskSnapshot.getTotalByteCount());
                                                                                                    cAProgressBar.setProgress((int)progress);
                                                                                                }
                                                                                            });
                                                                                            ...
                                                                                            documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                                                ...
                                                                                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                                                    ...
                                                                                                    String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                                                                                    DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                                                            url2.toString(),url3.toString(),url4.toString(),url5,userName,dateTime,"CA",pID);
                                                                                                    databaseReference.child(pID).setValue(departmentPost);
                                                                                                    String userId=firebaseAuth.getCurrentUser().getUid();
                                                                                                    DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                                                                                    databaseReference2.child(userId).child(pID).setValue(departmentPost);
                                                                        ...
                                                                        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                                            ...
                                                                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                                                ...
                                                                                String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                                                                DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                                        url2.toString(),url3.toString(),url4,url5,userName,dateTime,"CA",pID);
                                                                                databaseReference.child(pID).setValue(departmentPost);
                                                                                String userId=firebaseAuth.getCurrentUser().getUid();
                                                                                DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                                                                databaseReference2.child(userId).child(pID).setValue(departmentPost);
                                                    ...
                                                    documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                        ...
                                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                            ...
                                                            String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                                            DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                                    url2.toString(),url3,url4,url5,userName,dateTime,"CA",pID);
                                                            databaseReference.child(pID).setValue(departmentPost);
                                                            String userId=firebaseAuth.getCurrentUser().getUid();
                                                            DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                                            databaseReference2.child(userId).child(pID).setValue(departmentPost);
                                ...
                                documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                    ...
                                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                                        ...
                                        String dateTime=DateFormat.getDateTimeInstance().format(currentDate);
                                        DepartmentPost departmentPost=new DepartmentPost(title,body,dName,course,year,url1.toString(),
                                                url2,url3,url4,url5,userName,dateTime,"CA",pID);
                                        databaseReference.child(pID).setValue(departmentPost);
                                        String userId=firebaseAuth.getCurrentUser().getUid();
                                        DatabaseReference databaseReference2=FirebaseDatabase.getInstance().getReference("MY_POSTS");
                                        databaseReference2.child(userId).child(pID).setValue(departmentPost);
